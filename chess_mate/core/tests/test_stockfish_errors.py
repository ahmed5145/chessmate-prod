...
class TestStockfishErrors:
    ...
    def test_missing_evaluate_position(self, mocker):
        ...
        mock_engine.evaluate_position = MagicMock(side_effect=AttributeError("'SimpleEngine' object has no attribute 'evaluate_position'"))
    ...
    def test_invalid_score_format(self, mocker):
        ...
        mock_engine = MagicMock()
        mock_engine.analyse.return_value = {
            'score': 'invalid',  # Invalid score format
            'pv': [],
            'depth': 20
        }
