...
from ..models import Game, Profile, GameAnalysis, AiFeedback
...
class TestFeedbackViews:
    def test_generate_ai_feedback(self, authenticated_client, test_user, test_game):
        ...
        with patch.object(feedback_views, 'generate_game_feedback', return_value=(mock_feedback_content, 'gpt-4-turbo', credits_cost)) as mock_generate:
