...
urlpatterns = [
    ...
    path(
        "import/external/",
        game_views.import_external_games,
        name="import_external_games",
    ),
    ...
    path(
        ...
        game_views.check_analysis_status,
    ...
    path(
        ...
        game_views.check_batch_analysis_status,
        name="check_batch_analysis_status",
    ),
    path(
        "batch-reports/",
        game_views.list_batch_analysis_reports,
        name="list_batch_analysis_reports",
    ),
    path(
        "batch-reports/<int:report_id>/",
        game_views.get_batch_analysis_report,
