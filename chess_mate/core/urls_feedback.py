...
urlpatterns = [
    path(
        "<int:game_id>/generate/",
        feedback_views.generate_ai_feedback,
    ...
    path(
        "comparative/",
        feedback_views.generate_comparative_feedback,
        name="generate_comparative_feedback",
    ),
    path(
        "improvement/",
        feedback_views.get_improvement_suggestions,
