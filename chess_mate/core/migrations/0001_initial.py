    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['last_accessed'], name='analysis_ca_last_ac_b784f8_idx'), models.Index(fields=['priority'], name='analysis_ca_priorit_75983d_idx'), models.Index(fields=['expires_at'], name='analysis_ca_expires_3d3640_idx')],
            },
        ),
        migrations.CreateModel(
            name='Game',
            fields=[
                ...
                ('time_control_type', models.CharField(choices=[('bullet', 'Bullet'), ('blitz', 'Blitz'), ('rapid', 'Rapid'), ('classical', 'Classical')], default='blitz', max_length=20)),
                ...
                ('player_color', models.CharField(choices=[('white', 'White'), ('black', 'Black')], default='white', max_length=5)),
