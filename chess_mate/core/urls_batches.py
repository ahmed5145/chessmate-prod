...
urlpatterns = [
    ...
    path(
        "inbox/review/",
        views_batches.batch_inbox_review_view,
        name="batch-inbox-review",
    ),
    path(
        "inbox/freeze/",
        views_batches.batch_inbox_freeze_view,
        name="batch-inbox-freeze",
    ),
    path(
    ...
    path(
        "<int:batch_id>/status/", views_batches.batch_status_view, name="batch-status"
    ),
    path(
        "<int:batch_id>/report/", views_batches.batch_report_view, name="batch-report"
    ),
    path(
