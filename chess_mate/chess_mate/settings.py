...
SINGLE_GAME_COACH_MODEL = env("SINGLE_GAME_COACH_MODEL", default="gpt-4o-mini")
...
RATE_LIMIT = {
    ...
    # Status polling during long depth-20 reviews — separate from result fetches.
    "ANALYSIS_STATUS": {"MAX_REQUESTS": 120, "TIME_WINDOW": 60, "BACKEND": "default"},
}
...
RATE_LIMIT_ENDPOINT_PATTERNS = {
    ...
    "ANALYSIS_STATUS": [
        ...
        r"^/api(?:/v1)?/games/analysis/status/",
    ],
    "GAMES": [
        r"^/api(?:/v1)?/games/user/?$",
