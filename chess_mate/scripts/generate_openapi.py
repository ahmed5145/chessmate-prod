...
OPENAPI_SPEC = {
    ...
    "servers": [
        {
            "url": "https://api.chessmate.com/v1",
    ...
    "tags": [
        ...
        {
            "name": "Games",
            "description": "Endpoints for game management and analysis"
        },
        {
            "name": "User",
            "description": "Endpoints for user profile and settings"
        }
    ],
    "paths": {},
    "components": {
...
API_DOCS_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 
                           "docs", "api_reference.md")

# Path to output OpenAPI spec
OPENAPI_JSON_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                               "static", "openapi.json")
OPENAPI_YAML_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                               "static", "openapi.yaml")
...
def generate_path_item(endpoint):
    ...
    tag = "Authentication" if '/api/auth' in endpoint['url'] or any(auth_path in endpoint['url'] for auth_path in ['/login', '/register', '/logout', '/csrf', '/verify-email', '/password-reset', '/token']) else "Games"
