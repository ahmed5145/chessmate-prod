            ...
            <div className="mt-5 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="flex-grow flex flex-col">
                      <span className="text-sm font-medium text-gray-900">Spaced Moment Reminders</span>
                      <span className="text-sm text-gray-500">One gentle nudge per week about a critical moment (skipped when weekly digest sends)</span>
                    </span>
                    <button
                      type="button"
                      aria-label="Spaced Moment Reminders"
                      onClick={() => handlePreferenceChange("wants_spaced_repetition_email")}
                      className={`${
                        preferences.wants_spaced_repetition_email ? "bg-indigo-600" : "bg-gray-200"
                      } relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
                    >
                      <span
                        className={`${
