...
def check_python_version():
    ...
    print_status(f"Python version: {version_str}", version_ok, "Python 3.8 or higher is required")
...
def check_database_connection():
    ...
    try:
        ...
        print_status("Database connection", db_ok, result.stderr.strip() if not db_ok else None)
...
def check_environment_variables():
    ...
    try:
        ...
        print_status("python-dotenv package", False, "Package not installed, unable to load .env file")
