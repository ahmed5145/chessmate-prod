...
def main():
    ...
    parser.add_argument(
        "--test",
        choices=["all", "register", "login", "basic", "simple", "profile", "refresh"],
        default="all",
    ...
    tester = AuthTester(base_url=args.base_url, username=args.username, password=args.password, verbose=args.verbose)
